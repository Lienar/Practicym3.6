...
def send_welcome(message):
    ...
    bot.reply_to(message, "Send me an image, and I'll provide options for you!", reply_markup=get_start_keyboard())
...
def get_start_keyboard():
    ...
    keyboard.add(image_btn, jokes_btn)
    ''' Создание кнопок '''
    return keyboard
...
def get_options_keyboard():
    ...
    jokes_btn = types.InlineKeyboardButton("jokes", callback_data="jokes")
    ''' Описание кнопок клавиатуры '''
    keyboard.add(pixelate_btn, ascii_btn, reverse_btn, flip_btn, heatmap_btn, stiker_resize_btn, jokes_btn)
    ''' Создание кнопок '''
    return keyboard
